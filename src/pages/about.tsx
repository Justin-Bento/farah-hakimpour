      ...
      <main className="p-4 mb-16 space-y-16 wrapper">
        <section className="grid grid-cols-1 my-16 lg:grid-cols-2">
          <div className="w-full space-y-8 text-base font-medium leading-8 tracking-wider lg:max-w-prose">
            ...
            <p>
              When I&#39;m designing, you&#39;ll usually find me working my magic
              with Adobe Illustrator and Photoshop. For my art pieces, I use
              FireAlpaca and ibisPaint X, often with references to make sure
              everything looks just right. Music is my muse, and I love jamming
              out to BTS, Post Malone, Melanie Martinez, and MCR while I work. But
              when I need a break from the tunes, I dive into my favorite horror
              podcasts for some spooky inspiration.
            </p>
            <p>
              In my free time, you&#39;ll find me drawing fan art of my favorite
              YouTube personalities and TV shows, or creating original characters.
              I&#39;m always pushing myself to improve my skills and create better
              work, and I can&#39;t wait to see where my art takes me next.
            </p>
            <p>
              Thanks for stopping by my website, and I hope you enjoy checking out
              my portfolio! You can follow me on social-media for simpler
              projects.
            </p>
          </div>
        ...
        <section className="">
          <div className="max-w-[75ch]">
            <h2 className="text-4xl font-extrabold leading-[1.3] tracking-[0.02rem]">Client Testimonials for Farah Hakimpour&#39;s Creative Services</h2>
          </div>
