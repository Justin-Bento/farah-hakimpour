      ...
      <section className="relative min-h-screen overflow-hidden isolate lg:overflow-visible lg:px-0">
        <div className="absolute inset-0 overflow-hidden -z-10">
          ...
          >
            ...
            <svg x="50%" y={-1} className="overflow-visible fill-purple-200 dark:fill-purple-800/20">
              <path
        ...
        <article className=" max-w-[90ch] mx-auto my-8 lg:my-16 p-4">
          ...
          <h1 className="text-4xl lg:text-5xl/12 font-extrabold capitalize leading-normal [text-wrap: balance;] dark:text-white">Farah Hakimpour, an artist who specializes in digital art.</h1>
